    ...
    public class ItemDatabase : CRDatabase
    {
        ...
        public override void BuildDatabase()
        {
            ...
            items = new List<DbElement>()
            {
                ...
                new Item(216, "Woodpigeon breast", true, new Stats(), new Skills(), "The vermin of the sky, good riddance.", false, true),
                ...
                new Item(219, "Raw woodpigeon breast", true, new Stats(), new Skills(), "The vermin of the sky, good riddance.", false, true),
                new Item(220, "Raw corncrake breast", true, new Stats(), new Skills(), "A cute bird with a small brain.", false, true),
                //everything below this needs to update equipable.
                new Item(221, "Wood fishing rod", false, new Stats(), new Skills(), "A shabby wooden fishing rod.", false, false),
                new Item(222, "Bronze fishing rod", false, new Stats(), new Skills(), "A bronze fishing rod, used for fishing.", false, false),
                new Item(223, "Silver fishing rod", false, new Stats(), new Skills(), "A silver fishing rod, also used for fishing.", false, false),
                new Item(224, "Gold fishing rod", false, new Stats(), new Skills(), "A gold fishing rod. mainly used for fishing.", false, false),
                new Item(225, "Platinum fishing rod", false, new Stats(), new Skills(), "A platinum fishing rod. occasionally used for fishing.", false, false),
                new Item(226, "Ruby fishing rod", false, new Stats(), new Skills(), "A platinum fishing rod decorated with a ruby", false, true),
                new Item(227, "Emerald fishing rod", false, new Stats(), new Skills(), "A platinum fishing rod decorated with an emerald.", false, false),
                new Item(228, "Sapphire fishing rod", false, new Stats(), new Skills(), "A platinum fishing rod decorated with a sapphire.", false, false),
                new Item(229, "Wood harpoon", false, new Stats(), new Skills(), "A shabby wooden harpoon.", false, false),
                new Item(230, "Bronze harpoon", false, new Stats(), new Skills(), "A bronze harpoon.", false, false),
                new Item(231, "Silver harpoon", false, new Stats(), new Skills(), "A silver harpoon. cool.", false, false),
                new Item(232, "Gold harpoon", false, new Stats(), new Skills(), "A gold harpoon. epic.", false, false),
                new Item(233, "Platinum harpoon", false, new Stats(), new Skills(), "A platinum harpoon. wicked.", false, false),
                new Item(234, "Ruby harpoon", false, new Stats(), new Skills(), "A platinum harpoon decorated with a ruby", false, false),
                new Item(235, "Emerald harpoon", false, new Stats(), new Skills(), "A platinum harpoon decorated with an emerald.", false, false),
                new Item(236, "Sapphire harpoon", false, new Stats(), new Skills(), "A platinum harpoon decorated with a sapphire.", false, false),
                new Item(237, "Wood arrow on a rope", false, new Stats(), new Skills(), "A shabby wooden arrow on a rope.", false, false),
                new Item(238, "Bronze arrow on a rope", false, new Stats(), new Skills(), "A bronze arrow on a rope.", false, false),
                new Item(239, "Silver arrow on a rope", false, new Stats(), new Skills(), "A silver arrow on a rope. cool.", false, false),
                new Item(240, "Gold arrow on a rope", false, new Stats(), new Skills(), "A gold arrow on a rope. epic.", false, false),
                new Item(241, "Platinum arrow on a rope", false, new Stats(), new Skills(), "A platinum arrow on a rope. wicked.", false, false),
                new Item(242, "Ruby arrow on a rope", false, new Stats(), new Skills(), "A platinum arrow on a rope decorated with a ruby", false, false),
                new Item(243, "Emerald arrow on a rope", false, new Stats(), new Skills(), "A platinum arrow on a rope decorated with an emerald.", false, false),
                new Item(244, "Sapphire arrow on a rope", false, new Stats(), new Skills(), "A platinum arrow on a rope decorated with a sapphire.", false, false),
                new Item(245, "Fishing bait", true, new Stats(), new Skills(), "Bait used for catching fish, when they are desperate enough to bite a hook.", false, false),
                new Item(246, "Grubs", true, new Stats(), new Skills(), "Grubbies! saltwater fish love these.", false, false),
                new Item(247, "Worms", true, new Stats(), new Skills(), "Yummy, delicous worms! freshwater fish love these.", false, false),
                new Item(248, "Terrarium", true, new Stats(), new Skills(), "A little rectangular glass box used for breeding disgusting insects like grubs and worms", false, false),
                new Item(249, "Bass", true, new Stats(), new Skills(), "Medium-sized freshwater fish.", false, false),
                new Item(250, "Esox", true, new Stats(), new Skills(), "Medium-sized freshwater fish.", false, false),
                new Item(251, "Catfish", true, new Stats(), new Skills(), "Large freshwater fish, can also be found on the internet.", false, false),
                new Item(252, "Walleye", true, new Stats(), new Skills(), "Medium-sized freshwater fish.", false, false),
                new Item(253, "Muskellunge", true, new Stats(), new Skills(), "Medium-sized freshwater fish.", false, false),
                new Item(254, "Tuna", true, new Stats(), new Skills(), "Large saltwater fish.", false, false),
                new Item(255, "Tarpon", true, new Stats(), new Skills(), "Large saltwater fish.", false, false),
                new Item(256, "Marlin", true, new Stats(), new Skills(), "Large saltwater fish with a massive nose.", false, false),
                new Item(257, "Red drum", true, new Stats(), new Skills(), "Small saltwater fish.", false, false),
                new Item(258, "Salmon", true, new Stats(), new Skills(), "Medium-sized saltwater fish.", false, false),
