    ...
    public class ItemDatabase : CRDatabase
    {
        ...
        public override void BuildDatabase()
        {
            ...
            items = new List<DbElement>()
            {
                ...
                new Item(173, "Rodent trap", true, new Stats(), new Skills(), "Useful for catching rodents.", false, false),
                new Item(174, "Bird trap", true, new Stats(), new Skills(), "Conveniently made with two spoons.", false, false),
                new Item(175, "Deer bait", true, new Stats(), new Skills(), "The smell lures deer.", false, false),
                new Item(176, "Game call", false, new Stats(), new Skills(), "an odd sounding instrument that mimics the sound of deer.", false, false),
                new Item(177, "Green deer leather", true, new Stats(), new Skills(), "Leather that you took from a dead green deers body. you monster.", false, false),
                new Item(178, "Turquoise deer leather", true, new Stats(), new Skills(), "Leather that you took from a dead turquoise deers body. you monster.", false, false),
                new Item(179, "Blue deer leather", true, new Stats(), new Skills(), "Leather that you took from a dead blue deers body. you monster.", false, false),
                new Item(180, "Purple deer leather", true, new Stats(), new Skills(), "Leather that you took from a dead purple deers body. you monster.", false, false),
                new Item(181, "Red deer leather", true, new Stats(), new Skills(), "Leather that you took from a dead red deers body. you monster.", false, false),
                new Item(182, "Black deer leather", true, new Stats(), new Skills(), "Leather that you took from a dead black deers body. you monster.", false, false),
                new Item(183, "White deer leather", true, new Stats(), new Skills(), "Leather from a magnificent white deer. I hope you realize you might have killed the last of it's species.", false, false),
                new Item(184, "Green deer meat", true, new Stats(), new Skills(), "Yuck, only poor folks eat green deer meat.", false, false),
                new Item(185, "Turquoise deer meat", true, new Stats(), new Skills(), "The commoners favorite meat.", false, false),
                new Item(186, "Blue deer meat", true, new Stats(), new Skills(), "Tastes the same as pig, and they've spent their lives rolling around in the mud.", false, false),
                new Item(187, "Purple deer meat", true, new Stats(), new Skills(), "Deer meat with a wealthy taste.", false, true),
                new Item(188, "Red deer meat", true, new Stats(), new Skills(), "Doctors say eating red meat is bad for you.. but it tastes good so who cares.", false, false),
                new Item(189, "Black deer meat", true, new Stats(), new Skills(), "Finally some good fucking food.", false, false),
                new Item(190, "White deer meat", true, new Stats(), new Skills(), "Now this is some real gourmet shit.", false, false),
                new Item(191, "Raw green deer meat", true, new Stats(), new Skills(), "Yuck, only poor folks eat green deer meat.", false, false),
                new Item(192, "Raw Turquoise deer meat", true, new Stats(), new Skills(), "The commoners favorite meat.", false, false),
                new Item(193, "Raw blue deer meat", true, new Stats(), new Skills(), "Tastes the same as pig, and they've spent their lives rolling around in the mud.", false, false),
                new Item(194, "Raw purple deer meat", true, new Stats(), new Skills(), "Deer meat with a wealthy taste.", false, false),
                new Item(195, "Raw red deer meat", true, new Stats(), new Skills(), "Doctors say eating red meat is bad for you.. but it tastes good so who cares.", false, false),
                new Item(196, "Raw black deer meat", true, new Stats(), new Skills(), "Finally some good fucking food.", false, false),
                new Item(197, "Raw white deer meat", true, new Stats(), new Skills(), "Now this is some real gourmet shit.", false, false),
                new Item(198, "Mallard duck breast", true, new Stats(), new Skills(), "No more quacking for this duck.", false, false),
                new Item(199, "Tufted duck breast", true, new Stats(), new Skills(), "This duck waddled right into its own grave.", false, false),
                new Item(200, "Raw mallard duck breast", true, new Stats(), new Skills(), "No more quacking for this duck.", false, false),
                new Item(201, "Raw tufted duck breast", true, new Stats(), new Skills(), "This duck waddled right into its own grave.", false, false),
                new Item(202, "Canada goose breast", true, new Stats(), new Skills(), "I'm glad the big pest is dead.", false, false),
                new Item(203, "Greylag goose breast", true, new Stats(), new Skills(), "An average breast from an average goose.", false, false),
                new Item(204, "Pinkfoot goose breast", true, new Stats(), new Skills(), "Not sure if this was a goose or a duck.", false, false),
                new Item(205, "Raw canada goose breast", true, new Stats(), new Skills(), "I'm glad the big pest is dead.", false, false),
                new Item(206, "Raw greylag goose breast", true, new Stats(), new Skills(), "An average breast from an average goose.", false, false),
                new Item(207, "Raw pinkfoot goose breast", true, new Stats(), new Skills(), "Not sure if this was a goose or a duck.", false, false),
                new Item(208, "Featers", true, new Stats(), new Skills(), "Plucked from the dead body of some bird.", false, false),
                new Item(209, "Rabbit", true, new Stats(), new Skills(), "Small, cute, and begging to be eaten.", false, false),
                new Item(210, "Hare", true, new Stats(), new Skills(), "Big, fast, and very nutritious.", false, false),
                new Item(211, "Raw rabbit", true, new Stats(), new Skills(), "Small, cute, and begging to be cooked.", false, false),
                new Item(212, "Raw hare", true, new Stats(), new Skills(), "Big, fast, and soon to be very nutritious.", false, false),
                new Item(213, "Lucky rabbit's foot", true, new Stats(), new Skills(), "The foot of a rabbit, it's said to bring luck when worn as an amulet.", false, false),
                ...
                new Item(215, "Pheasant breast", true, new Stats(), new Skills(), "It used to be a beatiful bird, and now it's a beatiful meal.", false, false),
                new Item(216, "Woodpigeon breast", true, new Stats(), new Skills(), "The vermin of the sky, good riddance.", false, false),
                new Item(217, "Corncrake breast", true, new Stats(), new Skills(), "A cute bird with a small brain.", false, false),
                new Item(218, "Raw pheasant breast", true, new Stats(), new Skills(), "It used to be a beatiful bird, and now it's a beatiful corpse.", false, false),
                new Item(219, "Raw woodpigeon breast", true, new Stats(), new Skills(), "The vermin of the sky, good riddance.", false, false),
                new Item(220, "Raw corncrake breast", true, new Stats(), new Skills(), "A cute bird with a small brain.", false, false),
                ...
                new Item(259, "Seed dibber", false, new Stats(), new Skills(), "A useful tool, commonly used to make holes with.", false, false),
                new Item(260, "Spade", false, new Stats(), new Skills(), "A useful tool, commonly used to dig up plants or treasure!", false, false),
                new Item(261, "Compost", true, new Stats(), new Skills(), "Literal cow shit, apparently it makes your plants grow faster.", false, false),
                new Item(262, "Watering can", false, new Stats(), new Skills(), "A watering can is most commonly used for watering plants.", false, false),
                new Item(263, "Tomato seed", true, new Stats(), new Skills(), "If you put this in the ground and water it every day, a tomato plant will grow!", false, false),
                new Item(264, "Corn seed", true, new Stats(), new Skills(), "If you put this in the ground and water it every day, corn will grow!", false, false),
                new Item(265, "Lettuce seed", true, new Stats(), new Skills(), "If you put this in the ground and water it every day, lettuce will grow!", false, false),
                new Item(266, "Onion seed", true, new Stats(), new Skills(), "If you put this in the ground and water it every day, onions will grow!", false, false),
                new Item(267, "Tomato", true, new Stats(), new Skills(), "Round, red and very juicy!", false, false),
                new Item(268, "Corn", true, new Stats(), new Skills(), "Corn gang.", false, false),
                new Item(269, "Lettuce", true, new Stats(), new Skills(), "Edible plants.", false, false),
                new Item(270, "Onion", true, new Stats(), new Skills(), "You could technically eat these raw.", false, false),
                new Item(271, "Berries", true, new Stats(), new Skills(), "Smash 'em together to make jam.", false, false),
                new Item(272, "Hay", true, new Stats(), new Skills(), "Dried up grass, animals love this.", false, false),
                new Item(273, "Animal medicine", true, new Stats(), new Skills(), "Only meant for animals, wesket!", false, false),
                new Item(274, "Shears", false, new Stats(), new Skills(), "You can shear sheep with this.", false, false),
                new Item(275, "Milk", true, new Stats(), new Skills(), "Came from a cows udders, think about that for a second.", false, false),
                new Item(276, "Goat milk", true, new Stats(), new Skills(), "This milk was intended to feed baby goats with, but you took it.", false, false),
                new Item(277, "Egg", true, new Stats(), new Skills(), "an egg.", false, false),
                new Item(278, "Wool", true, new Stats(), new Skills(), "Very soft.", false, false),
                new Item(279, "Cook's book", true, new Stats(), new Skills(), "It used to belong to the late town's cook, now it's yours.", false, false),
                new Item(280, "Burnt deer meat", true, new Stats(), new Skills(), "This meat has lost it's taste and color, what a waste.", false, false),
                new Item(281, "Burnt fish", true, new Stats(), new Skills(), "This fish has lost it's taste and color, what a waste.", false, false),
                new Item(282, "Burnt duck", true, new Stats(), new Skills(), "This duck has lost it's taste and color, what a waste.", false, false),
                new Item(283, "Burnt goose", true, new Stats(), new Skills(), "This goose has lost it's taste and color, what a waste.", false, false),
                new Item(284, "Burnt rabbit", true, new Stats(), new Skills(), "This rabbit has lost it's taste and color, what a waste.", false, false),
                new Item(285, "Burnt bird", true, new Stats(), new Skills(), "This bird has lost it's taste and color, what a waste.", false, false),
                new Item(286, "Over-fried egg", true, new Stats(), new Skills(), "some would just call it burnt.", false, false),
                new Item(287, "Deer with tomato", false, new Stats(), new Skills(), "The tomatoes look homegrown, it would be disrespectful not to eat them.", false, false),
                new Item(288, "Deer with corn", false, new Stats(), new Skills(), "Seems like a solid meal.", false, false),
                new Item(289, "Deer with lettuce", false, new Stats(), new Skills(), "Teasing the dead deer with his favorite grass.", false, false),
                new Item(290, "Deer with onion", false, new Stats(), new Skills(), "Deer and onion.", false, false),
                new Item(291, "Deer with cheese", false, new Stats(), new Skills(), "A lump of deer with some molten cheese on top.", false, false),
                new Item(292, "Deer with milk", false, new Stats(), new Skills(), "The milk brings a creamy element to the meal.", false, false),
                new Item(293, "Burnt deer with tomato", true, new Stats(), new Skills(), "The meal looks burnt, it would alright not to eat this.", false, false),
                new Item(294, "Burnt deer with corn", true, new Stats(), new Skills(), "Seems like a burnt meal.", false, false),
                new Item(295, "Burnt deer with lettuce", true, new Stats(), new Skills(), "Teasing the burnt dead deer with his favorite grass.", false, false),
                new Item(296, "Burnt deer with onion", true, new Stats(), new Skills(), "Burnt deer and onion.", false, false),
                new Item(297, "Burnt deer with cheese", true, new Stats(), new Skills(), "A burnt lump of deer with some molten cheese on top.", false, false),
                new Item(298, "Burnt deer with milk", true, new Stats(), new Skills(), "The milk brings a creamy element to the meal. Unfortunately the meal needs more than that to be saved.", false, false),
                new Item(299, "Duck with tomato", false, new Stats(), new Skills(), "Not a big meal, but it should do the job.", false, false),
                new Item(300, "Duck with corn", false, new Stats(), new Skills(), "A lovely conbination.", false, false),
                new Item(301, "Duck with lettuce", false, new Stats(), new Skills(), "The lettuce makes the duck feel at home one last time.", false, false),
                new Item(302, "Duck with onion", false, new Stats(), new Skills(), "Duck and onion.", false, false),
                new Item(303, "Duck with cheese", false, new Stats(), new Skills(), "You'd better tone down the mouth watering, the duck might swim away.", false, false),
                new Item(304, "Duck with milk", false, new Stats(), new Skills(), "A daring combination.", false, false),
                new Item(305, "Burnt duck with tomato", true, new Stats(), new Skills(), "I don't think this'll do the job.", false, false),
                new Item(306, "Burnt duck with corn", true, new Stats(), new Skills(), "A true disappointment.", false, false),
                new Item(307, "Burnt duck with lettuce", true, new Stats(), new Skills(), "Must have reminded it of the warm summer days.", false, false),
                new Item(308, "Burnt duck with onion", true, new Stats(), new Skills(), "Burnt duck and onion.", false, false),
                new Item(309, "Burnt duck with cheese", true, new Stats(), new Skills(), "You ruined it.", false, false),
                new Item(310, "Burnt duck with milk", true, new Stats(), new Skills(), "I guess it didn't work out.", false, false),
                new Item(311, "Goose with tomato", false, new Stats(), new Skills(), "HONK.", false, false),
                new Item(312, "Goose with corn", false, new Stats(), new Skills(), "HONK HONK.", false, false),
                new Item(313, "Goose with lettuce", false, new Stats(), new Skills(), "HONK HONK HONK.", false, false),
                new Item(314, "Goose with onion", false, new Stats(), new Skills(), "Goose and onion.", false, false),
                new Item(315, "Goose with cheese", false, new Stats(), new Skills(), "HONK HONK HONK HONK.", false, false),
                new Item(316, "Goose with milk", false, new Stats(), new Skills(), "HONK x5.", false, false),
                new Item(317, "Burnt goose with tomato", true, new Stats(), new Skills(), "sad honk.", false, false),
                new Item(318, "Burnt goose with corn", true, new Stats(), new Skills(), "sad honk honk.", false, false),
                new Item(319, "Burnt goose with lettuce", true, new Stats(), new Skills(), "sad honk honk honk.", false, false),
                new Item(320, "Burnt goose with onion", true, new Stats(), new Skills(), "Burnt goose and onion.", false, false),
                new Item(321, "Burnt goose with cheese", true, new Stats(), new Skills(), "sad honk honk honk honk.", false, false),
                new Item(322, "Burnt goose with milk", true, new Stats(), new Skills(), "sad honk x5.", false, false),
                new Item(323, "Rabbit with tomato", false, new Stats(), new Skills(), "Can't tell if it's a regular rabbit or a hare.. they're the same really.", false, false),
                new Item(324, "Rabbit with corn", false, new Stats(), new Skills(), "Who thought this was a good idea?", false, false),
                new Item(325, "Rabbit with lettuce", false, new Stats(), new Skills(), "Are you trying to feed a dead rabbit?", false, false),
                new Item(326, "Rabbit with onion", false, new Stats(), new Skills(), "Rabbit and onion.", false, false),
                new Item(327, "Rabbit with cheese", false, new Stats(), new Skills(), "This rabbit has a yellow blanket.", false, false),
                new Item(328, "Rabbit with milk", false, new Stats(), new Skills(), "Looks like it drowned :(.", false, false),
                new Item(329, "Burnt rabbit with tomato", true, new Stats(), new Skills(), "Burnt rabbit and hare still look the same.", false, false),
                new Item(330, "Burnt rabbit with corn", true, new Stats(), new Skills(), "I told you it was a bad idea.", false, false),
                new Item(331, "Burnt rabbit with lettuce", true, new Stats(), new Skills(), "Not surprised you burned that one.", false, false),
                new Item(332, "Burnt rabbit with onion", true, new Stats(), new Skills(), "Burnt rabbit and onion.", false, false),
                new Item(333, "Burnt rabbit with cheese", true, new Stats(), new Skills(), "No yellow blanket for this fella.", false, false),
                new Item(334, "Burnt rabbit with milk", true, new Stats(), new Skills(), ":(", false, false),
                new Item(335, "Fish with tomato", false, new Stats(), new Skills(), "Not very appealing.", false, false),
                new Item(336, "Fish with corn", false, new Stats(), new Skills(), "As in 'A plate with fish and corn', not 'fishing with corn as bait'.", false, false),
                new Item(337, "Fish with lettuce", false, new Stats(), new Skills(), "How creative.", false, false),
                new Item(338, "Fish with onion", false, new Stats(), new Skills(), "Fish and onion.", false, false),
                new Item(339, "Fish with cheese", false, new Stats(), new Skills(), "Not to be confused with fish and chips.", false, false),
                new Item(340, "Fish with milk", false, new Stats(), new Skills(), "One last swim.", false, false),
                new Item(341, "Burnt fish with tomato", true, new Stats(), new Skills(), "Even less appealing.", false, false),
                new Item(342, "Burnt fish with corn", true, new Stats(), new Skills(), "Try paying more attention next time.", false, false),
                new Item(343, "Burnt fish with lettuce", true, new Stats(), new Skills(), "Definitely original.", false, false),
                new Item(344, "Burnt fish with onion", true, new Stats(), new Skills(), "Burnt fish and onion.", false, false),
                new Item(345, "Burnt fish with cheese", true, new Stats(), new Skills(), "Atrocious.", false, false),
                new Item(346, "Burnt fish with milk", true, new Stats(), new Skills(), "Read the name, what enlightenment did you expect to find here?.", false, false),
                new Item(347, "Fried egg with tomato", false, new Stats(), new Skills(), "Great for breakfast.", false, false),
                new Item(348, "Fried egg with corn", false, new Stats(), new Skills(), "Great for lunch.", false, false),
                new Item(349, "Fried egg with lettuce", false, new Stats(), new Skills(), "Great for dinner.", false, false),
                new Item(350, "Fried egg with onion", false, new Stats(), new Skills(), "Fried egg and onion", false, false),
                new Item(351, "Fried egg with cheese", false, new Stats(), new Skills(), "Great as snack", false, false),
                new Item(352, "Fried egg with milk", false, new Stats(), new Skills(), "Eat it whenever.", false, false),
                new Item(353, "Burnt Fried egg with tomato", true, new Stats(), new Skills(), "Not so great for breakfast.", false, false),
                new Item(354, "Burnt Fried egg with corn", true, new Stats(), new Skills(), "Not so great for lunch.", false, false),
                new Item(355, "Burnt Fried egg with lettuce", true, new Stats(), new Skills(), "Not so great for dinner", false, false),
                new Item(356, "Burnt Fried egg with onion", true, new Stats(), new Skills(), "Burnt egg and onion", false, false),
                new Item(357, "Burnt Fried egg with cheese", true, new Stats(), new Skills(), "Not so great as snack.", false, false),
                new Item(358, "Burnt Fried egg with milk", true, new Stats(), new Skills(), "Don't eat it.", false, false),
                new Item(359, "Egg salad", false, new Stats(), new Skills(), "An egg with some weeds or something.", false, false),
                new Item(360, "Cheese salad", false, new Stats(), new Skills(), "Healthy salad.", false, false),
                new Item(361, "Cheese", true, new Stats(), new Skills(), "This also came from a cow's udders indirectly.", false, false),
                new Item(362, "Goat cheese", true, new Stats(), new Skills(), "Significantly different from a cow's cheese.", false, false),
                new Item(363, "Jam", true, new Stats(), new Skills(), "A bunch of berries mashed together.", false, false),
                new Item(364, "Wool carpet", true, new Stats(), new Skills(), "A very soft carpet.", false, false),
                new Item(365, "Wool blanket", true, new Stats(), new Skills(), "A very soft blanket.", false, false),
            };
